...
(function($) {
    ...
    $(function() {
        ...
        $('#contact-form').on('submit', function(e) {
            ...
            if (!e.isDefaultPrevented()) {
                ...
                var url = "https://script.google.com/macros/s/AKfycbx_oIck91Vu2Xv5gE0cQDHv7f-jCT55MpZBpvvsDQ/exec";
                $('#contact-form').find('.btn-send').prop('value', 'Sending Message');
                $('#contact-form').find('.btn-send').prop('disabled', true);
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $(this).serialize(),
                    success: function(data) {
                        console.log('asdasdasdasdasd', data.type);
                        ...
                        $('#contact-form').find('.btn-send').remove();
    ...
    $(document).on('ready', function() {
        ...
        $('.subpages').on("swipeleft", function() {
